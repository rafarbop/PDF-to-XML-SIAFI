...
with st.sidebar:
    ...
    st.caption('[Modelo_Folha_Pagamentos_Auxilios.pdf](https://raw.githubusercontent.com/rafarbop/PDF-to-XML-SIAFI/main/public/examples/Modelo_Folha_Pagamento_auxilios_SISAE_202505.pdf)')
